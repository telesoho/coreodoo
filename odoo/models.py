...
class BaseModel(metaclass=MetaModel):
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def _init_constraints_onchanges(cls):
        ...
        for (key, dumy, dumy) in cls._sql_constraints:
    ...
    def _export_rows(self, fields, *, _is_toplevel_call=True):
        ...
        def none_splittor(rs):
            return rs

        if not _is_toplevel_call:
            splittor = none_splittor
        else:
            splittor = default_splittor
...
%(fields_list)s"""
    ...
    def write(self, vals):
        ...
        * .. _openerp/models/relationals/format:
        ...
        with env.protecting(protected, self):
            ...
            for flds in determine_inverses.values():
                ...
                try:
                    flds[0].determine_inverse(real_recs)
    ...
    def create(self, vals_list):
        ...
        with self.env.protecting(protected):
            ...
            for flds in field_groups:
                # determine which records to inverse for those fields
                inv_names = {field.name for field in flds}
                rec_vals = [
                    (
                        data["record"],
                        {
                ...
                if all(field.store or field.company_dependent for field in flds):
                    batches = [rec_vals]
                else:
                ...
                for batch in batches:
                    ...
                    flds[0].determine_inverse(batch_recs)
    ...
    def flush(self, fnames=None, records=None):
        ...
        if fnames is None:
            ...
            for model_name, flds in model_fields.items():
                if any(
                    field.name in vals
